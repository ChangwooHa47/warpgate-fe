      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20">
          ...
          <div className="aspect-square md:aspect-auto bg-milk rounded-sm overflow-hidden min-h-[360px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3165.0!2d127.0276!3d37.4979!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca15a8e530a3d%3A0x9fcf543e4b7fa06c!2z7YWM7Zek656A66Gc!5e0!3m2!1sko!2skr!4v1700000000000"
              width="100%"
              height="100%"
