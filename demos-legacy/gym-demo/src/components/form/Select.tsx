      ...
      <div className={className}>
        ...
        <div className="relative">
          <select
            ...
            className={`w-full appearance-none border bg-night-800 px-4 py-3 pr-10 text-sm transition-colors focus:outline-none focus:border-mint-500 ${
              props.value ? "text-steel-100" : "text-steel-500"
