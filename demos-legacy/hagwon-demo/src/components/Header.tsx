      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm">
        <div className="flex items-center justify-between px-8 md:px-12 lg:px-16 py-5">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link href="/courses" className="text-[15px] font-medium hover:text-gray-600 transition-colors">강좌소개</Link>
            <Link href="/teachers" className="text-[15px] font-medium hover:text-gray-600 transition-colors">강사소개</Link>
            <Link href="/schedule" className="text-[15px] font-medium hover:text-gray-600 transition-colors">시간표</Link>
            <button
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-gray-100 bg-white px-8 py-6">
            <nav className="flex flex-col gap-4">
              <Link href="/courses" className="text-base font-medium" onClick={() => setMenuOpen(false)}>강좌소개</Link>
              <Link href="/teachers" className="text-base font-medium" onClick={() => setMenuOpen(false)}>강사소개</Link>
              <Link href="/schedule" className="text-base font-medium" onClick={() => setMenuOpen(false)}>시간표</Link>
              <button
