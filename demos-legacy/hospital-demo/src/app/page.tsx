...
import { SITE, DOCTORS, NOTICES, EVENTS, PRESS } from "@/data/siteData";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
            ...
            <div className="flex gap-4 p-5 bg-white rounded-xl border border-gray-200" style={{ boxShadow: '0 0 20px rgba(0,0,0,0.06)' }}>
              ...
              <div className="flex flex-col flex-1">
                ...
                <Link href="/directions" className="text-base font-medium hover:underline mt-auto pt-1" style={{ color: '#a0aab5' }}>
                  자세히 보기 &rarr;
                </Link>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex items-end justify-between mb-10 border-b-2 border-[var(--primary)] pb-4">
            ...
            <Link href="/doctors" className="text-base text-gray-400 hover:text-[#1265c8] transition shrink-0">
              더보기
            </Link>
          </div>
      ...
      <section className="py-20 bg-gray-50/70">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-end justify-between mb-10 border-b-2 border-[var(--primary)] pb-4">
            ...
            <Link href="/notices" className="text-base text-gray-400 hover:text-[#1265c8] transition shrink-0">
              더보기
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="flex items-end justify-between mb-6 border-b-2 border-[var(--primary)] pb-4">
                ...
                <Link href="/notices" className="text-base text-gray-400 hover:text-[#1265c8] transition">
                  더보기
                </Link>
              </div>
