        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/appointment" className="hover:text-gray-800 transition inline-flex items-center gap-1.5 group">
                  <span className="w-1 h-1 rounded-full bg-gray-300 group-hover:bg-[#1780e8] transition" />
                  진료 예약
                </Link>
              </li>
              <li>
                <Link href="/directions" className="hover:text-gray-800 transition inline-flex items-center gap-1.5 group">
                  <span className="w-1 h-1 rounded-full bg-gray-300 group-hover:bg-[#1780e8] transition" />
                  오시는 길
                </Link>
              </li>
              <li>
                <Link href="/notices" className="hover:text-gray-800 transition inline-flex items-center gap-1.5 group">
                  <span className="w-1 h-1 rounded-full bg-gray-300 group-hover:bg-[#1780e8] transition" />
                  공지사항
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-gray-800 transition inline-flex items-center gap-1.5 group">
                  <span className="w-1 h-1 rounded-full bg-gray-300 group-hover:bg-[#1780e8] transition" />
                  상담·문의
                </Link>
              </li>
