    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "GEL NAIL", ko: "젤 네일", desc: "오래 지속되는 광택과 선명한 컬러. 원컬러부터 프렌치, 그라데이션까지.", href: "/menu" },
            { title: "NAIL ART", ko: "네일 아트", desc: "핸드페인팅, 3D 아트, 스톤 데코까지. 아티스트의 손끝에서 완성되는 작품.", href: "/menu" },
            { title: "NAIL CARE", ko: "네일 케어", desc: "건강한 손톱을 위한 프리미엄 케어. 스파 트리트먼트와 영양 관리.", href: "/menu" },
          ].map((s) => (
            <Link
              key={s.title}
              href={s.href}
