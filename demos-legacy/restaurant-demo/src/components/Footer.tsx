        ...
        <div className="grid gap-12 md:gap-10 md:grid-cols-[1.2fr_0.8fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-sm text-stone-600 hover:text-charcoal-700 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/menu" className="text-sm text-stone-600 hover:text-charcoal-700 transition-colors">
                  Menu
                </Link>
              </li>
              <li>
                <Link href="/reservation" className="text-sm text-stone-600 hover:text-charcoal-700 transition-colors">
                  Reservation
                </Link>
              </li>
            </ul>
