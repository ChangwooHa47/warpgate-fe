...
import { FIRM_NAME, MOCK_USER } from "../../_lib/constants";

const BASE_PATH = "/demo/accounting";

const navLinks = [
  { href: `${BASE_PATH}/services`, label: "서비스 소개" },
  { href: `${BASE_PATH}/consultation`, label: "세무 상담" },
  { href: `${BASE_PATH}/portal`, label: "고객 포털" },
];
...
export default function Header() {
  ...
  const isHome = pathname === BASE_PATH || pathname === `${BASE_PATH}/`;
