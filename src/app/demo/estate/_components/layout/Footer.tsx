          ...
          <div className="flex gap-12">
            <div>
              ...
              <ul className="space-y-2">
                {[
                  { href: "/demo/estate/properties", label: "매물 검색" },
                  { href: "/demo/estate/areas", label: "지역 정보" },
                  { href: "/demo/estate/consultation", label: "상담 예약" },
                ].map((item) => (
                  <li key={item.href}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["강남구", "서초구", "송파구", "용산구"].map((area) => (
                  <li key={area}>
                    <Link href="/demo/estate/areas" className="text-[14px] text-gray-500 hover:text-gray-800 transition-colors">
                      {area}
                    </Link>
                  </li>
                ))}
