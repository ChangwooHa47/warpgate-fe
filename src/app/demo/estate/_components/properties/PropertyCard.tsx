...
import { formatPrice, formatArea, formatViewCount } from "../../_lib/utils";
import { TYPE_COLORS } from "../../_lib/constants";
import { ViewIcon, BookmarkIcon, CheckIcon } from "../ui/Icons";
...
function PropertyCard({ property, variant = "grid" }: PropertyCardProps) {
  ...
  if (variant === "featured") {
    return (
      <Link
        href={`/demo/estate/properties/${property.id}`}
