...
import { PropertyFilter as FilterType, TransactionType, ViewMode } from "../../_lib/types";
import { PRICE_MIN, PRICE_MAX, AREA_MIN, AREA_MAX, DEFAULT_FILTER, TYPE_COLORS, REGIONS } from "../../_lib/constants";
import { ListIcon, GridIcon, CloseIcon } from "../ui/Icons";
