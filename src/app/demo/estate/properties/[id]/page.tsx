    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/demo/estate/properties" className="text-primary hover:underline">
            매물 목록으로 돌아가기
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <nav className="flex items-center gap-2 text-sm text-muted mb-6">
        <Link href="/demo/estate" className="hover:text-foreground">
          홈
        </Link>
        <span>/</span>
        <Link href="/demo/estate/properties" className="hover:text-foreground">
          매물 검색
        </Link>
        <span>/</span>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 space-y-4">
            <div className="bg-white border border-border rounded-2xl p-6">
              ...
              <Link
                href={`/demo/estate/consultation?propertyId=${property.id}`}
