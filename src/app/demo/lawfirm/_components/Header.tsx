...
const navLinks = [
  { href: "/demo/lawfirm/practice-areas", label: "업무분야" },
  { href: "/demo/lawfirm/attorneys", label: "변호사 소개" },
  { href: "/demo/lawfirm/cases", label: "업무사례" },
];
...
export default function Header() {
  ...
  const isHome = pathname === "/demo/lawfirm";
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
        <Link href="/demo/lawfirm" className="flex items-center gap-2">
        ...
        <nav className="hidden items-center gap-10 md:flex">
          ...
          <Link
            href="/demo/lawfirm/consultation"
