        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                { label: "이용약관", href: "/demo/mall/service" },
                { label: "개인정보처리방침", href: "/demo/mall/service" },
                { label: "이메일무단수집거부", href: "/demo/mall/service" },
                { label: "고객의 소리", href: "/demo/mall/service" },
                { label: "분실물 센터", href: "/demo/mall/service" },
              ].map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
